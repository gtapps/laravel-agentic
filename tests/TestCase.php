...
abstract class TestCase extends Orchestra
{
     ...
     * points this at mysql/pgsql service containers to prove the whole suite
     * — the approvals unique index, the guarded updates, and every JSON
     * column round-trip — holds on real RDBMSes and not just sqlite.
     */
